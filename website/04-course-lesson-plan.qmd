...
# Appraisal of Published Causal Studies via the Causal Roadmap
...
# Analysis of a Publicly Available Dataset via the Causal Roadmap
...
- Utilize estimation procedures via `R` (e.g., IPW, G-estimation, or causal mediation analysis), which should be consistent with the outlined causal model.
