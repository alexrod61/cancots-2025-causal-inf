...
format: 
  revealjs:
    css: styles.css
    footer: Canadian Conference on Teaching Statistics (CanCOTS) 2025
    slide-number: true
    slide-level: 4
    transition: none
include-in-header:
...
::: incremental
- Is there any room within the course to include <span style="color: purple;">Bayesian thinking</span>?
